...
import { FaPhoneAlt, FaRegAddressBook, FaRegSquare, FaUser } from "react-icons/fa";
import { FaLocationDot, FaRegSquareCheck } from "react-icons/fa6";
import { HiOutlineCloudDownload } from "react-icons/hi"; // Removed GrEdit as it was not used
import { MdEmail, MdOutlineOpenInFull } from "react-icons/md";
            ...
            <div className='lg:w-full flex lg:flex-row flex-col justify-center h-full'>
                <div className='lg:w-1/5 lg:h-[700px] bg-blue-50 shadow-lg m-4 rounded-xl'>
                    ...
                    <div className='hidden md:block lg:block mt-4 px-4 h-96'>
                        <div className='my-2 text-xl font-bold flex flex-row items-center justify-between'><p>Personal details</p><AiFillEdit /></div>
                        ...
                        <div className='my-2 text-xl font-bold flex flex-row items-center justify-between mr-4'><p>Invoices</p></div>
                        <div className='w-full bg-blue-200 p-2 rounded-md flex flex-row items-center justify-between'>
                            <p>#p12-basi-12.02.2024</p>
                            <p className='flex flex-row gap-2'><HiOutlineCloudDownload /><MdOutlineOpenInFull /></p>
                        </div>
                    </div>
                </div>
                <Cchat /> {/* Your chat section */}
                <div className='lg:w-1/5 md:-[700px] lg:h-[700px] bg-blue-50 shadow-lg m-4 rounded-xl'>
                    <div className='bg-gradient-to-r from-sky-500 to-indigo-600 md:h-40 lg:h-40 p-2 rounded-t-xl m-1 text-white'>
                        <div className='font-bold text-lg'>Current Package</div>
                    ...
                    <div className='p-2 rounded-xl bg-gradient-to-b from-sky-500 to-indigo-600 text-white font-bold text-center mx-5 hover:bg-gradient-to-t'>
                        Close the deal
                    </div>
                </div>
            </div>
